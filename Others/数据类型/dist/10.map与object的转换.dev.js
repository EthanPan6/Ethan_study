...
var map = new Map([['1', 'str1'], [1, 'num1'], [true, 'bool1']]);
alert(map.get('1')); // str1
// 键值对 [key, value] 数组生产普通对象

var prices = Object.fromEntries([['banana', 1], ['orange', 2], ['meat', 4]]); // 现在 prices = { banana: 1, orange: 2, meat: 4 }
...
map3.set('orange', 2);
map3.set('meat', 4);
var obj2 = Object.fromEntries(map3.entries()); // 创建一个普通对象（plain object）(*)
// 完成了！
// obj = { banana: 1, orange: 2, meat: 4 }

alert(obj2.orange); // 2

var obj3 = Object.fromEntries(map3); // 省掉 .entries()
