...
//纪念日
let startDay = "2019/1/1";
//当地拼音,需要在下面的墨迹天气url确认
const local = "zhejiang/nanchang";
...
let EamilAuth = {
    //   user: "xxx@126.com",
    user: "alwaysmrp@vip.qq.com",
    pass: "opxiseeunyuabbji"
};
//发送者昵称与邮箱地址
let EmailFrom = '"ethan" <alwaysmrp@vip.qq.com>';

//接收者邮箱地
let EmailTo = "ethan5161@aliyun.com";
// let EmailTo = "alwaysmrp@vip.qq.com";
//邮件主题
let EmailSubject = "一封暖暖的小邮件";

//每日发送时间
let EmailHour = 18;
let EmialMinminute = 56;
