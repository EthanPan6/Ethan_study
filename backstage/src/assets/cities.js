...
export default addressInit = function (_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea) {
    let cmbProvince = document.getElementById(_cmbProvince);
    let cmbCity = document.getElementById(_cmbCity);
    let cmbArea = document.getElementById(_cmbArea);
    ...
    function changeCity() {
        ...
        let item = cmbCity.options[cmbCity.selectedIndex].obj;
    ...
    function changeProvince() {
        ...
        let item = cmbProvince.options[cmbProvince.selectedIndex].obj;
        for (let i = 0; i < item.cityList.length; i++) {
